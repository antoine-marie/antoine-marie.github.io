...
** 7. A similarity renormalization group approach to Green's function methods  ([[file:pdf/07_SRGGW.pdf][pdf]])
*A. Marie* and P.-F. Loos.

J. Chem. Theory. Comput. (submitted) | [[https://arxiv.org/abs/2303.05984][arXiv]]
...
** 6. Excited states, symmetry breaking, and unphysical solutions in state-specific CASSCF theory ([[file:pdf/06_CASLSP.pdf][pdf]])
*A. Marie* and H. G. A. Burton.

J. Phys. Chem. A (submitted) | [[https://arxiv.org/abs/2301.11731][arXiv]]
...
** 5. Connections between many-body perturbation and coupled-cluster theories ([[file:pdf/05_CCvsMBPT.pdf][pdf]])
...
** 4. Real space Mott-Anderson electron localization with long-range interactions: exact and approximate descriptions ([[file:pdf/04_MBLKSSCE.pdf][pdf]])
